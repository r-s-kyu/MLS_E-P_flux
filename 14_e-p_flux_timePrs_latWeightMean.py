...
contf0 = axes[0].contourf(X,Y,nablaF0[:,sInd:eInd+1],interval,cmap='PuOr_r',extend='both') #cmap='bwr_r'で色反転, extend='both'で範囲外設定
...
contf1 = axes[1].contourf(X,Y,nablaF1[:,sInd:eInd+1],interval,cmap='PuOr_r',extend='both') #cmap='bwr_r'で色反転, extend='both'で範囲外設定
